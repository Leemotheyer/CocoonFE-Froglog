...
Pre-release **alpha** APKs: **`cocoon-froglog-*-alpha`** on **[Releases](https://github.com/Leemotheyer/CocoonFE-Froglog/releases)** (latest: [cocoon-froglog-1.0.4-alpha](https://github.com/Leemotheyer/CocoonFE-Froglog/releases/tag/cocoon-froglog-1.0.4-alpha)).
...
3. Install (`adb install -r cocoon-froglog-1.0.4-alpha.apk`). **Stock Cocoon can stay installed** — package `rip.moth.cocoonshell.froglog`, launcher **Cocoon (Froglog)**.
