...
Pre-release **alpha** APKs: **`cocoon-froglog-*-alpha`** on **[Releases](https://github.com/Leemotheyer/CocoonFE-Froglog/releases)** (latest: [cocoon-froglog-1.0.9-alpha](https://github.com/Leemotheyer/CocoonFE-Froglog/releases/tag/cocoon-froglog-1.0.9-alpha)).
...
3. **Uninstall** any older `rip.moth.cocoonshell.froglog`, then install **`cocoon-froglog-1.0.9-alpha.apk`**. Launcher: **Cocoon (Froglog 1.0.9-alpha)**. After building locally, run `./scripts/run-froglog-apk-tests.sh` before sideloading.
