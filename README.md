...
Pre-release **alpha** APKs: **`cocoon-froglog-*-alpha`** on **[Releases](https://github.com/Leemotheyer/CocoonFE-Froglog/releases)** (latest: [cocoon-froglog-1.0.8-alpha](https://github.com/Leemotheyer/CocoonFE-Froglog/releases/tag/cocoon-froglog-1.0.8-alpha)).
...
3. **Uninstall** any older `rip.moth.cocoonshell.froglog` first, then install (`adb install cocoon-froglog-1.0.8-alpha.apk`). Launcher should read **Cocoon (Froglog 1.0.8-alpha)**.
