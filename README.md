...
Pre-release **alpha** APKs: **`cocoon-froglog-*-alpha`** on **[Releases](https://github.com/Leemotheyer/CocoonFE-Froglog/releases)** (latest: [cocoon-froglog-1.0.2-alpha](https://github.com/Leemotheyer/CocoonFE-Froglog/releases/tag/cocoon-froglog-1.0.2-alpha)).

1. Download **`cocoon-froglog-<version>-alpha.apk`** from Releases.
2. Enable install from unknown sources, then install (`adb install -r cocoon-froglog-1.0.2-alpha.apk`). **Stock Cocoon can stay installed** — package `rip.moth.cocoonshell.froglog`, launcher **Cocoon (Froglog)**.
