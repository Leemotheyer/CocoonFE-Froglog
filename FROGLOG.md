...
| Froglog Pod + sync code | **`froglog-core`** + `./scripts/build-froglog-apk.sh` → `android/dist/cocoon-froglog.apk`; **alpha APKs:** [Releases](https://github.com/Leemotheyer/CocoonFE-Froglog/releases) (`cocoon-froglog-*-alpha`) |
